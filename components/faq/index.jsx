        ...
        <div class="grid md:grid-cols-6 gap-6">
          <div class="md:col-span-2">
            <div class="max-w-xs">
              ...
              <p class="mt-3 hidden md:block text-gray-600 dark:text-gray-400">
            ...
            <div class="hs-accordion-group divide-y divide-gray-200 dark:divide-gray-700">
              ...
              >
                ...
                >
                  ...
                  <svg
                    class="hs-accordion-active:hidden block w-3 h-3 text-gray-200 group-hover:text-gray-500 dark:text-gray-400"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
                  ...
                  <svg
                    class="hs-accordion-active:block hidden w-3 h-3 text-gray-200 group-hover:text-gray-500 dark:text-gray-400"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
