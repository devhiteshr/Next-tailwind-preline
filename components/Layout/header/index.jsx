...
const Header = () => {
  return (
    <div>
      <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm py-3 md:py-0 nav-bar">
        <nav
          class="mt-3 max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8"
          aria-label="Global"
        >
            ...
            >
              <div class="overflow-hidden overflow-y-auto max-h-[75vh] scrollbar-y">
                <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:pl-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                  <Link
                    class="font-medium text-gray-200 hover:text-gray-500 py-3 md:py-6 dark:hover:text-gray-500"
                    href="#"
                    aria-current="page"
                  >
                    Landing
                  ...
                  <div class="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] py-3 md:py-4">
                    <button
                      type="button"
                      class="flex items-center w-full text-gray-200 hover:text-gray-400 font-medium dark:hover:text-gray-500"
                    >
                      Resources
                      <svg
                        class="ml-2 w-2.5 h-2.5 text-gray-200"
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
                        fill="none"
                    ...
                    <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full left-0 min-w-[15rem] bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-gray-800 dark:divide-gray-700 before:absolute before:-top-5 before:left-0 before:w-full before:h-5">
                      <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="flex flex-col mx-1 md:mx-0">
                          <Link
                            class="group flex gap-x-5 text-gray-800 hover:bg-gray-100 rounded-md p-4 dark:text-gray-200 dark:hover:bg-gray-900"
                            href="#"
                          >
                            <svg
                        ...
                        <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                          ...
                          <Link
                            class="mt-4 group flex gap-x-5 items-center"
                            href="#"
                          >
                            <Image
                  ...
                  <div class="pt-3 md:pt-0">
                    <Link
                      class="inline-flex justify-center items-center gap-x-2 text-center bg-white border h-9 border-transparent text-black text-m rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2 focus:ring-offset-white transition py-2.5 px-3 dark:focus:ring-offset-gray-800"
                      href="#"
                    >
                      Contact Us
                    </Link>
