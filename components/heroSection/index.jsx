...
import HeroImage from "../../assets/demo-img.png";

const HeroSection = () => {
  return (
    <section class="hero-section">
    <div class=" xl:pt-24 mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 hero-container items-end ">
        <div class="hero-data xl:pb-12">
          <h1 class="block text-3xl font-bold text-white sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
            Mordern admin UI kit built with React & Tailwind
          </h1>
          <p class="mt-3 text-lg text-white">
            Elstar has a complete set of UI components crafted with Tailwind
            that fulfilled most of the use case which allows you to
            kickstart any project, saving up thousands of hours!
          </p>
          <div class="mt-7 grid gap-3 w-full sm:inline-flex">
            ...
            <Link
              class="inline-flex justify-center items-center gap-x-3.5 text-sm lg:text-base text-center border hover:border-gray-300 shadow-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition py-3 px-4 dark:border-gray-800 dark:hover:border-gray-600 dark:shadow-slate-700/[.7] dark:text-white dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800 text-white"
              href="#"
            >
              Contact sales team
            </Link>
          ...
          <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            <div class="py-5">
              ...
              <div class="mt-5">
                <svg
                  class="h-auto w-16 text-white dark:text-white"
                  width="80"
                  height="27"
                  viewBox="0 0 80 27"
                  fill="none"
